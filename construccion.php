...
<head>
    ...
    <!-- Page Title -->
    <title> Extralum - <?php echo $texto['sectores_construccion']; ?> </title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
                        <h2><?php echo $texto['menu_cabecera_sectores']; ?>: <?php echo $texto['menu_cabecera_construccion']; ?></h2>
                        <ol class="breadcrumb">
                            <li><a href="index.php"><?php echo $texto['menu_cabecera_inicio']; ?></a></li>
                            <li><?php echo $texto['menu_cabecera_construccion']; ?></li>
                        </ol>
                    </div>
                </div> <!-- end row -->
            </div> <!-- end container -->
                ...
                <div class="row">
                    <div class="col col-md-8 col-md-push-4">
                        <div class="service-single-content">
                            <h3><?php echo $texto['sectores_construccion']; ?></h3>
                            <p></p>
                            <!-- <div class="img-holder">
                                <img src="assets/images/sectores/img-3.jpg" alt>
                            </div>-->
                            <div class="img-holder">
                                <img src="assets/images/sectores/img-3-2.jpg" >
                            </div>
                            <div class="img-holder">
                                <img src="assets/images/sectores/img-3-3.jpg" >
                            </div>
                            <div class="img-holder">
                                <img src="assets/images/sectores/img-3-4.jpg" >
                            </div>
                            <div>
                            ...
                            <div class="widget link-widget">
                                <ul>
                                   <li><a href="#"><?php echo $texto['menu_cabecera_sectores']; ?></a></li>
                                    ...
                                    <li class="active"><a href="construccion.php"><?php echo $texto['sectores_construccion']; ?></a></li>

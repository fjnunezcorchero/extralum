...
<head>
    ...
    <!-- Page Title -->
    <title> Extralum <?php echo $texto['sectores_decoracion']; ?></title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
                        <h2><?php echo $texto['menu_cabecera_sectores']; ?>: <?php echo $texto['menu_cabecera_decoracion']; ?></h2>
                        <ol class="breadcrumb">
                            <li><a href="index.php"><?php echo $texto['menu_cabecera_inicio']; ?></a></li>
                            <li><?php echo $texto['menu_cabecera_decoracion']; ?></li>
                        </ol>
                    </div>
                </div> <!-- end row -->
            </div> <!-- end container -->
                ...
                <div class="row">
                    <div class="col col-md-8 col-md-push-4">
                        <div class="service-single-content">
                            <h3><?php echo $texto['sectores_decoracion']; ?></h3>
                            <p></p>
                            <div class="img-holder">
                                <img src="assets/images/sectores/accesorios_cocina.jpg" >
                            </div>
                            <div>
                            ...
                            <div class="widget link-widget">
                                <ul>
                                   <li><a href="#"><?php echo $texto['menu_cabecera_sectores']; ?></a></li>
                                    ...
                                    <li class="active"><a href="decoracion.php"><?php echo $texto['sectores_decoracion']; ?></a></li>

...
<head>
    ...
    <!-- Page Title -->
    <title> Extralum - <?php echo $texto['servicio_extrusion']; ?> </title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
                        <h2><?php echo $texto['servicio_extrusion']; ?></h2>
                        <ol class="breadcrumb">
                            <li><a href="index.php"><?php echo $texto['menu_cabecera_inicio']; ?></a></li>
                            <li><?php echo $texto['servicio_extrusion']; ?></li>
                        </ol>
                    </div>
                </div> <!-- end row -->
            </div> <!-- end container -->
                ...
                <div class="row">
                    <div class="col col-md-8 col-md-push-4">
                        <div class="service-single-content">
                            <h3><?php echo $texto['extrusion_cabecera']; ?></h3>
                            <p><?php echo $texto['extrusion_texto_1']; ?></p>
                            <p><?php echo $texto['extrusion_texto_2']; ?></p>
                            <div class="img-holder">
                                <img src="assets/images/service-single/img-1.jpg">
                            </div>
                            <p>&nbsp;</p>
                            <p><?php echo $texto['extrusion_texto_3']; ?></p>
                            <p><?php echo $texto['extrusion_texto_4']; ?></p>
                            <div class="img-holder">
                                <img src="assets/images/projects/img-2.jpg">
                            </div>
                            <p>&nbsp;</p>
                            <p><?php echo $texto['extrusion_texto_5']; ?></p>
                            <p><?php echo $texto['extrusion_texto_6']; ?></p>
                            <p><?php echo $texto['extrusion_texto_7']; ?></p>
                        ...
                        <div class="service-sidebar">
                            <div class="widget link-widget">
                                <ul>
                                    ...
                                    <li class="active"><a href="extrusion.php"><?php echo $texto['servicio_extrusion']; ?></a></li>
                            ...
                            <div class="widget brochures-widget">
                                <h3><?php echo $texto['bocas_de_prensa']; ?></h3>
                                <p><?php echo $texto['bocas_de_prensa_texto_1']; ?></p>
                                <div class="btns">
                                    <a href="assets/documentos/boca prensa 1800.pdf" target="_blank"><i class="fa fa-file-pdf-o"></i> <?php echo $texto['boca_de_prensa_1800']; ?></a>
                                    <a href="assets/documentos/boca prensa 2200.pdf" target="_blank"><i class="fa fa-file-pdf-o"></i> <?php echo $texto['boca_de_prensa_2200']; ?></a>
                                    <a href="assets/documentos/boca prensa 4000.pdf" target="_blank"><i class="fa fa-file-pdf-o"></i> <?php echo $texto['boca_de_prensa_4000']; ?></a>
                                </div>
                            </div>
                        </div>
                    </div>

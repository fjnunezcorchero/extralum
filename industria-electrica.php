...
<head>
    ...
    <!-- Page Title -->
    <title> Extralum - <?php echo $texto['sectores_industria']; ?> </title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
                        <h2><?php echo $texto['menu_cabecera_sectores']; ?>: <?php echo $texto['menu_cabecera_industria']; ?></h2>
                        <ol class="breadcrumb">
                            <li><a href="index.php"><?php echo $texto['menu_cabecera_inicio']; ?></a></li>
                            <li><?php echo $texto['menu_cabecera_industria']; ?></li>
                        </ol>
                    </div>
                </div> <!-- end row -->
            </div> <!-- end container -->
                ...
                <div class="row">
                    <div class="col col-md-8 col-md-push-4">
                        <div class="service-single-content">
                            <h3><?php echo $texto['sectores_industria']; ?></h3>
                            <p></p>
                            <div class="img-holder">
                                <img src="assets/images/sectores/img-4.jpg" >
                            </div>
                            <div>
                            ...
                            <div class="row">
								<div class="col-md-3 img-holder">
	                                <img src="assets/images/sectores/img-4-2.jpg" >
	                            </div>
                            
	                            <div class="col-md-3 img-holder">
	                                <img src="assets/images/sectores/Solar-1.jpg" >
	                            </div>
	                            <div class="col-md-3 img-holder">
	                                <img src="assets/images/sectores/cables de conductores de aluminio.jpg" >
	                            </div>
                            
	                            <div class="col-md-3 img-holder">
	                                <img src="assets/images/sectores/Producto_1_2.jpg" >
	                            </div>
	                        </div>
                            ...
                            <div class="widget link-widget">
                                <ul>
                                   <li><a href="#"><?php echo $texto['menu_cabecera_sectores']; ?></a></li>
                                    ...
                                    <li><a href="ferrovial.php"><?php echo $texto['sectores_ferrovial']; ?></a></li>
                                    <li><a href="construccion.php"><?php echo $texto['sectores_construccion']; ?></a></li>
                                    <li class="active"><a href="industria-electrica.php"><?php echo $texto['sectores_industria']; ?></a></li>

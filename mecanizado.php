...
<head>
    ...
    <!-- Page Title -->
    <title> Extralum - <?php echo $texto['servicio_mecanizado']; ?> </title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
                        <h2><?php echo $texto['servicio_mecanizado']; ?></h2>
                        <ol class="breadcrumb">
                            <li><a href="index.php"><?php echo $texto['menu_cabecera_inicio']; ?></a></li>
                            <li><?php echo $texto['servicio_mecanizado']; ?></li>
                        </ol>
                    </div>
                </div> <!-- end row -->
            </div> <!-- end container -->
                    ...
                    <div class="col col-md-8 col-md-push-4">
                        <div class="service-single-content">
                            ...
                            <div class="img-holder">
                                <img src="assets/images/service-single/img-4.jpg">
                            </div>
                            <div>
                        ...
                        <div class="service-sidebar">
                            <div class="widget link-widget">
                                <ul>
                                    ...
                                    <li class="active"><a href="mecanizado.php"><?php echo $texto['servicio_mecanizado']; ?></a></li>

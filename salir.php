...
if (isset($_SESSION["sesion"])) $sesion->desactivaSesion($_SESSION["sesion"]);

$id = 0;
if (isset($_REQUEST['id'])) $id = $_REQUEST['id'];

switch ($id) {
    case 345: $mensaje = 'No tiene permisos suficientes.'; break;
    default: $mensaje = 'Su sesion ha sido cerada'; break;
}
?>
<!DOCTYPE html>
<html lang="en">
